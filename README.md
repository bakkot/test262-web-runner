...
You can either provide a local .zip of the repo (with or without .git/), or click 'Remote' to load the one hosted in this repository. It was last updated on [22 November, 2016](https://github.com/tc39/test262/commit/3ed2c78).